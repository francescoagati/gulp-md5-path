...
_$Manifest_Path_$Impl_$.__name__ = true;
...
_$Manifest_AManifest_$Impl_$.__name__ = true;
...
PathTools.getType = function(path) {
	if(PathTools.isHttp(path)) return TypePath.http(path); else return TypePath.file(path);
};
